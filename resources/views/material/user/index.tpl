										...
										<div class="card-inner">
											<div class="tab-content">
												<div class="tab-pane fade active in" id="all_windows">
													<p>点击 → <a href="/ssr-download/ss-win.zip">下载</a>，解压并运行程序(如果提示缺少.netFrameWork 4.X,就先下载更新.netFrameWork 4.X)，然后按照下面的方法配置节点<br>
														...
														右键右下角的小飞机 → 服务器 → 扫面屏幕上的二维码，配置信息会自动配置到程序。<br>
														(4)右键右下角的小飞机 → 勾选“启用系统代理” → 系统代理模式选“全局模式” → 在“pac”中点击“从GFWlist更新本地pac” → 系统代理模式选“pac模式”<br>
														好了,现在基本大功告成，打开浏览器就可以自由上网了，记得选择“开机启动” ~~~ </p>
